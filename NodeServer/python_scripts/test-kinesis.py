...
STREAM_NAME = "ExampleTelemetryTest"
...
while(True):
    ...
    f2 = open("../public/POS_Data.csv", "a")
    csv_writer3 = writer(f2)
    ...
    num8 = coordinates[z][0]
    num9 = coordinates[z][1]

    csv_writer3.writerow([num8, num9, num4])
    ...
    inverter_file = open("../public/INV_Data.csv", "a")
    csv_writer_inverter = writer(inverter_file)
    inverter_array = []

    for i in range(0,45):
        num = random.randrange(1,50)
        inverter_array.append(num)

    inverter_array.append(num4)

    csv_writer_inverter.writerow([i for i in inverter_array])
    inverter_file.close()
...
'''
    accumulator_file = open("../public/AMS_Data.csv", "a")
    csv_writer_accumulator = writer(accumulator_file)
    accumulator_array = []

    for i in range(0,45):
        num = random.randrange(45,50)
        accumulator_array.append(num)

    accumulator_array.append(num4)
